 ...
 * The server stores an ArrayList of Client objects to perform the broadcast.
 *
...
public class MtServer {
  ...
  private void getConnection() {
    ...
    try {
      System.out.println("Waiting for client connections on port 9017.");
      ServerSocket serverSock = new ServerSocket(9017);
      // This is an infinite loop, the user will have to shut it down
      // using control-c
      while (true) {
        Socket connectionSock = serverSock.accept();
        
        // Create a new Client object for the connected client
